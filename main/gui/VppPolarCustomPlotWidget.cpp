...
VppPolarCustomPlotWidget::VppPolarCustomPlotWidget(
	...
	// add the graph title at the top of the chart:
	...
	circle->topLeft->setCoords(-1,1);
	circle->bottomRight->setCoords(1,-1);
...
void VppPolarCustomPlotWidget::mouseDoubleClickEvent(QMouseEvent* pMouseEvent) {
...
void VppPolarCustomPlotWidget::keyPressEvent(QKeyEvent *event) {
...
void VppPolarCustomPlotWidget::changeGraphSelection(int key){
...
void VppPolarCustomPlotWidget::selectionChanged() {
...
void VppPolarCustomPlotWidget::mousePress() {
...
void VppPolarCustomPlotWidget::mouseWheel() {
