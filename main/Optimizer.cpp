...
int optIterations = 0;
int optConstrIterations = 0;
int optConstrIterations2 = 0;
...
// Set the constraint function for benchmark g13:
void Optimizer::VPPconstraint(unsigned m, double *result, unsigned n, const double* x, double* grad, void* f_data) {
...
void Optimizer::run() {
  ...
  // Set the constraint equation for SF=0 and SM=0
  opt.add_equality_mconstraint(VPPconstraint, NULL, tol);
